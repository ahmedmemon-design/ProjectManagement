...
const ActivitiesSection = ({ workspaceId }) => {
  ...
  const getFileIcon = (file) => {
    ...
    switch (fileType) {
      ...
      case 'rar':
      case '7z':
        return <FiArchive className="w-6 h-6 text-yellow-500" />;
      case 'jpg':
      case 'jpeg':
      case 'png':
      case 'gif':
          ...
          <div className="flex justify-between items-center">
            ...
            {isAdmin && (
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all flex items-center gap-2 shadow-sm"
              >
        ...
        {files.length > 0 ? (
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      disabled={activeFileId === file.id}
                      className="px-3 py-1.5 bg-gradient-to-r from-blue-50 to-blue-100 text-blue-600 rounded-lg hover:from-blue-100 hover:to-blue-200 transition-all flex items-center gap-1.5 disabled:opacity-50"
                    >
                      {activeFileId === file.id ? (
                        <>
                  ...
                  <div className="p-4">
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-medium rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {activeFileId === file.id ? (
                          <FiLoader className="w-4 h-4 animate-spin" />
                        ) : (
          ...
          <div className="text-center py-16 border-2 border-dashed border-gray-300 rounded-xl bg-gradient-to-b from-gray-50 to-white">
            ...
            {isAdmin && (
              <button
                onClick={() => setShowUploadModal(true)}
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all flex items-center gap-2 mx-auto shadow-md"
              >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {uploading ? (
                      <>
                        <FiLoader className="w-4 h-4 animate-spin" />
