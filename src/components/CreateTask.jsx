...
export default function CreateTask({ workspaceId, userId, onTaskCreated }) {
  ...
  const createTask = async (e) => {
    ...
    try {
      ...
      // Upload attachments to database if any
    ...
    <div className="relative">
      ...
      >
        <div>
          ...
          <p className="text-sm text-gray-600">Add a new task with attachments</p>
        </div>
        ...
        <div>
          ...
          <input
            className="w-full border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-colors"
        ...
        <div>
          ...
          <textarea
            className="w-full border border-gray-300 p-3 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition-colors min-h-[100px] resize-y"
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 rounded-lg font-medium hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow"
        >
          {loading ? (
